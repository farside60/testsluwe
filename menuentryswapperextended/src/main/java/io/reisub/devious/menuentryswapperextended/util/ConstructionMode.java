...
public enum ConstructionMode {
  // Didn't include expensive/marble/obsidian items because I doubt anyone is training construction
  // that way and it's probably best so people don't one click yeet 3m gp on accident.
  ATTACK_STONE(
      "Attack Stone",
