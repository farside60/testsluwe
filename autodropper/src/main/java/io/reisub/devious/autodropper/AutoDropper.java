...
public class AutoDropper extends Plugin implements KeyListener {
  ...
  protected void startUp() {
    log.info("Starting Sluwe Auto Dropper");
  ...
  protected void shutDown() {
    log.info("Stopping Sluwe Auto Dropper");
  ...
  private void drop() {
    List<Item> items = Inventory.getAll(SluwePredicates.itemConfigList(configList));
