...
import io.reisub.devious.utils.enums.Log;
...
public interface Config extends net.runelite.client.config.Config {
  ...
  @ConfigItem(
      ...
      name = "Equip graceful",
      description = "Deposit current equipment and equip graceful before starting a run",
      position = 5)
  ...
  @ConfigItem(
      ...
      description =
          "Force teleport usage at your house "
  ...
  @ConfigItem(
      ...
      description =
          "Use teleport method at house as a fallback when out of items "
