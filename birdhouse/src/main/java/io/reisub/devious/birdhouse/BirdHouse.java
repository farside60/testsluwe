...
import io.reisub.devious.birdhouse.tasks.AddSeeds;
import io.reisub.devious.birdhouse.tasks.BuildBirdHouse;
import io.reisub.devious.birdhouse.tasks.CraftBirdhouse;
import io.reisub.devious.birdhouse.tasks.Deposit;
import io.reisub.devious.birdhouse.tasks.EmptyBirdHouse;
import io.reisub.devious.birdhouse.tasks.GetTools;
import io.reisub.devious.birdhouse.tasks.GoToBirdHouse;
import io.reisub.devious.birdhouse.tasks.GoToIsland;
import io.reisub.devious.birdhouse.tasks.GoToMushroomMeadow;
import io.reisub.devious.birdhouse.tasks.GoToVerdantValley;
import io.reisub.devious.birdhouse.tasks.HandleBank;
import io.reisub.devious.birdhouse.tasks.HarvestSeaweed;
import io.reisub.devious.birdhouse.tasks.NoteSeaweed;
import io.reisub.devious.birdhouse.tasks.PickupSpore;
import io.reisub.devious.birdhouse.tasks.PlantSeaweed;
import io.reisub.devious.birdhouse.tasks.StartRun;
import io.reisub.devious.birdhouse.tasks.Teleport;
