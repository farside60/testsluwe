package io.reisub.devious.smithing.tasks;

import io.reisub.devious.smithing.Config;
import io.reisub.devious.smithing.Smithing;
...
public class Smith extends Task {
  ...
  public void execute() {
    ...
    Time.sleepTicksUntil(() -> plugin.isCurrentActivity(Smithing.SMITHING), 10);
  }
}
