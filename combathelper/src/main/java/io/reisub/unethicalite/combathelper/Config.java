...
public interface Config extends net.runelite.client.config.Config {
  ...
  @ConfigItem(
      ...
      description =
          "Names or IDs of your melee gear. Names match any item containing the name, meaning "
              + "'Dharok's platelegs' matches all degradation values. Separate by line, "
              + "semicolon or comma.",
      section = "swapConfig",
      position = 601)
  ...
  @ConfigItem(
      ...
      name = "5:1 method",
      description =
          "Enable to use the 5:1 method at Hunleff (5 attacks with ranged, "
