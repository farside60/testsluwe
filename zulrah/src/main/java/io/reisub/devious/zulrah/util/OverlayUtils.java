package io.reisub.devious.zulrah.util;
...
public class OverlayUtils {
  ...
  public static void renderTextLocation(
      Graphics2D graphics, Point txtLoc, String text, Color color, Supplier outline) {
  ...
  public static void renderPolygon(
      Graphics2D graphics, Shape polygon, Color color, int outlineStroke, int fillAlpha) {
    if (polygon != null) {
      graphics.setColor(color);
  ...
  public static void renderWidgetPolygon(
      Graphics2D graphics, Widget widget, Color color, boolean outlineOnly, boolean flash) {
    if (widget != null) {
