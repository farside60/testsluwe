...
public interface ZulrahConfig extends Config {
  @ConfigSection(name = "Zulrah", description = "", position = 0, closedByDefault = true)
  String zulrahSection = "zulrahSection";

  @ConfigSection(name = "Fight Helper", description = "", position = 1, closedByDefault = true)
  String fightHelperSection = "fightHelperSection";

  @ConfigSection(name = "Phase Helper", description = "", position = 2, closedByDefault = true)
  String phaseHelperSection = "phaseHelperSection";

  @ConfigSection(name = "Miscellaneous", description = "", position = 3, closedByDefault = true)
  ...
  @ConfigItem(
      ...
      description =
          "Displays a attack tick counter on Zulrah showing how long until the next auto attack",
      position = 1,
      section = zulrahSection)
  ...
  @ConfigItem(
      ...
      description =
          "Displays a total tick counter infobox showing how long Zulrah has "
              + "been alive for in ticks",
      position = 3,
      section = zulrahSection)
  ...
  @ConfigItem(
      ...
      description =
          "Displays an overlay showing the correct prayer to use for the entirety "
              + "of the Zulrah fight<br>Changes color dependent on whether or not you're "
              + "praying correctly or not",
      position = 0,
  ...
  @ConfigItem(
      ...
      description =
          "Marks the correct prayer to use in the prayer book to use for the entirety "
              + "of the Zulrah fight<br>Changes color dependent on whether or not you're "
              + "praying correctly or not",
      position = 1,
      section = fightHelperSection)
  ...
  @ConfigItem(
      ...
      description =
          "Displays text over your head showing when it's safe to turn off your "
              + "overheads<br>Overlay gets displayed when Zulrah is not actively targeting "
              + "you and your overheads are on",
      position = 2,
      section = fightHelperSection)
  ...
  @ConfigItem(
      ...
      description =
          "Overlay: Displays Zulrah's phases details on an overlay<br>Tile: "
              + "Displays Zulrah's phases details on tiles",
      position = 0,
  ...
  @ConfigItem(
      ...
      description =
          "Current: Only displays the current Zulrah phase<br>Next: "
              + "Only displays the next Zulrah phase<br>",
      position = 1,
      section = phaseHelperSection)
  ...
  @ConfigItem(
      ...
      description =
          "Requires: Display Type ('Overlay' or 'Both')<br>Displays text above InfoBox "
  ...
  @ConfigItem(
      ...
      keyName = "phaseTags",
      description =
          "Tags each Zulrah phase on the tile overlay with:<br>"
              + "[Current] = Current Zulrah phase<br>"
              + "[Next] = Definite next Zulrah phase<br>"
  ...
  @ConfigItem(
      ...
      description =
          "Displays an overlay showing how long Zulrah has been alive in minutes:seconds "
              + "format<br>Timer resets on Zulrah death and/or leaving of the instance "
              + "of any fashion",
      position = 0,
  ...
  @ConfigItem(
      ...
      description =
          "Remove Att. Op.: Removes the 'Attack' option from all the active Snakelings<br>"
  ...
  @ConfigItem(
      ...
      description =
          "Displays when and where the Snakeling/Toxic Clouds projectile will "
              + "approximately land",
      position = 5,
      section = miscellaneousSection)
